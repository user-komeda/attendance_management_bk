...
RSpec.describe ::Infrastructure::Repository::User::UserRepository do
  ...
  it 'returns domain entity when found by id' do
    infra_entity = ::Infrastructure::Entity::User::UserEntity.new(id: '00000000-0000-0000-0000-000000000001', first_name: 'Hanako', last_name: 'Suzuki', email: 'hanako@example.com')
    rom = double('RomRepo')
  ...
  it 'builds infra on create and returns domain entity' do
    domain = build_domain_user(id: "00000000-0000-0000-0000-000000000001", first_name: 'Ken', last_name: 'Tanaka', email: 'ken@example.com')
    created_struct = Struct.new(:id, :first_name, :last_name, :email).new('00000000-0000-0000-0000-000000000001', 'Ken', 'Tanaka', 'ken@example.com')
  ...
  it 'builds infra on update and returns domain entity' do
    domain = build_domain_user(id: "00000000-0000-0000-0000-000000000001", first_name: 'New', last_name: 'Name', email: 'new@example.com')
    updated_struct = Struct.new(:id, :first_name, :last_name, :email).new('00000000-0000-0000-0000-000000000001', 'New', 'Name', 'new@example.com')
