...
type DialogAnimation = 'default' | 'none'
  ...
  return (
    <DialogPrimitive.Overlay
      class={cn(
        ...
        dialogOverlayAnimationClass[props.animation ?? 'default'],
        props.class,
      )}
      {...rest}
    />
...
const DialogContent = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DialogPortal>
      <DialogOverlay animation={props.animation} />
      <DialogPrimitive.Content
        class={cn(
          'bg-background fixed top-1/2 left-1/2 z-50 grid max-h-screen w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto border p-6 shadow-lg sm:rounded-lg',
          dialogContentAnimationClass[props.animation ?? 'default'],
          props.class,
        )}
        {...rest}
      >
