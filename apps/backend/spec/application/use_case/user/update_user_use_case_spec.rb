...
RSpec.describe ::Application::UseCase::User::UpdateUserUseCase do
  ...
  it 'updates and returns user dto' do
    ...
    input = ::Application::Dto::User::UpdateUserInputDto.new(id: 5, first_name: 'New', last_name: 'Name',
  ...
  it 'raises not found when user missing' do
    ...
    input = ::Application::Dto::User::UpdateUserInputDto.new(id: 123, first_name: 'A', last_name: 'B',
                                                             email: 'a@example.com')
