    ...
    module WorkSpace
      class WorkSpaceBaseUseCase < BaseUseCase
        ...
        MEMBER_SHIPS_REPOSITORY = Constant::ContainerKey::DomainRepositoryKey::WORK_SPACE_DOMAIN_REPOSITORY[:member_ships]
                                  .key.freeze # : String
        CONTENT_API_REPOSITORY = Constant::ContainerKey::DomainRepositoryKey::WORK_SPACE_DOMAIN_REPOSITORY[:content_api]
                                 .key.freeze # : String
        ...
        CONTENT_API_DTO = Dto::WorkSpace::ContentApiDto.freeze # : singleton(Dto::WorkSpace::ContentApiDto)
      end
    end
  end
end
